...
silent only
cd /mnt/almacen/workspace/pydup
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 pydup/pydup.py
argglobal
silent! argdel *
edit pydup/pydup.py
...
143
normal! zo
let s:l = 154 - ((39 * winheight(0) + 29) / 59)
